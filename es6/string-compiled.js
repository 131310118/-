 ...
 */
var _name$password = { name: 'wangjun', password: '123456' },
    name = _name$password.name,
    password = _name$password.password;

var str = '<div>this is a div</div>' + '<p>' + name + '</p>' + '<p>' + password + '</p>' + '<div>this is another div</div>';
